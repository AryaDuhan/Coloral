...
- **Passive Anti-Cheat**: The frontend monitors suspicious browser events (e.g. opening Snipping Tool, taking screenshots, tabbing out during the memorize phase) and silently alerts the bot owner without alerting the player.
